...
- Major version: CUDA 12
- Initial image baseline: `12.4.1-devel-ubuntu22.04`
- Host systems may run a newer driver as long as it remains compatible with CUDA 12 job containers
