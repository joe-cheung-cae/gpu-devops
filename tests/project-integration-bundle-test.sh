...
run_export_third_party_cache_test() {
  ...
  cp -a "${ROOT_DIR}/third_party/install-third-party.sh" "${repo_dir}/third_party/install-third-party.sh"
  cp -a "${ROOT_DIR}/third_party/install-chrono.sh" "${repo_dir}/third_party/install-chrono.sh"
  cp -a "${ROOT_DIR}/third_party/install-eigen3.sh" "${repo_dir}/third_party/install-eigen3.sh"
  cp -a "${ROOT_DIR}/third_party/install-openmpi.sh" "${repo_dir}/third_party/install-openmpi.sh"
  cp -a "${ROOT_DIR}/third_party/install-hdf5.sh" "${repo_dir}/third_party/install-hdf5.sh"
  cp -a "${ROOT_DIR}/third_party/install-h5engine.sh" "${repo_dir}/third_party/install-h5engine.sh"
  cp -a "${ROOT_DIR}/third_party/install-muparserx.sh" "${repo_dir}/third_party/install-muparserx.sh"
  ...
  printf 'placeholder\n' > "${repo_dir}/third_party/cache/cmake-3.26.0-linux-x86_64.tar.gz"
  ...
  assert_file_exists "${repo_dir}/third_party/cache/cmake-3.26.0-linux-x86_64.tar.gz"
  ...
  assert_tar_contains "${test_dir}/bundle.tar.gz" "assets/third_party/cache/cmake-3.26.0-linux-x86_64.tar.gz"
...
run_export_test() {
  ...
  case "${mode}" in
    all)
      ...
      assert_file_exists "${test_dir}/assets/third_party/install-third-party.sh"
      assert_file_exists "${test_dir}/assets/third_party/install-chrono.sh"
      assert_file_exists "${test_dir}/assets/third_party/install-eigen3.sh"
      assert_file_exists "${test_dir}/assets/third_party/install-openmpi.sh"
      assert_file_exists "${test_dir}/assets/third_party/install-hdf5.sh"
      assert_file_exists "${test_dir}/assets/third_party/install-h5engine.sh"
      assert_file_exists "${test_dir}/assets/third_party/install-muparserx.sh"
      ...
      assert_file_exists "${test_dir}/assets/third_party/cache/cmake-3.26.0-linux-x86_64.tar.gz"
...
write_import_bundle() {
  ...
  if [[ "${mode}" == "all" || "${mode}" == "assets" ]]; then
    mkdir -p \
      ...
      "${bundle_root}/assets/third_party" \
    ...
    cp "${ROOT_DIR}/third_party/install-third-party.sh" "${bundle_root}/assets/third_party/install-third-party.sh"
    cp "${ROOT_DIR}/third_party/install-chrono.sh" "${bundle_root}/assets/third_party/install-chrono.sh"
    cp "${ROOT_DIR}/third_party/install-eigen3.sh" "${bundle_root}/assets/third_party/install-eigen3.sh"
    cp "${ROOT_DIR}/third_party/install-openmpi.sh" "${bundle_root}/assets/third_party/install-openmpi.sh"
    cp "${ROOT_DIR}/third_party/install-hdf5.sh" "${bundle_root}/assets/third_party/install-hdf5.sh"
    cp "${ROOT_DIR}/third_party/install-h5engine.sh" "${bundle_root}/assets/third_party/install-h5engine.sh"
    cp "${ROOT_DIR}/third_party/install-muparserx.sh" "${bundle_root}/assets/third_party/install-muparserx.sh"
    ...
    cp "${ROOT_DIR}/third_party/cache/cmake-3.26.0-linux-x86_64.tar.gz" "${bundle_root}/assets/third_party/cache/cmake-3.26.0-linux-x86_64.tar.gz"
    cp "${ROOT_DIR}/third_party/cache/CMake-hdf5-1.14.1-2.tar.gz" "${bundle_root}/assets/third_party/cache/CMake-hdf5-1.14.1-2.tar.gz"
...
run_import_test() {
  ...
  case "${mode}" in
    all)
      ...
      assert_file_exists "${target_dir}/.gpu-devops/third_party/install-third-party.sh"
      assert_file_exists "${target_dir}/.gpu-devops/third_party/install-chrono.sh"
      assert_file_exists "${target_dir}/.gpu-devops/third_party/install-eigen3.sh"
      assert_file_exists "${target_dir}/.gpu-devops/third_party/install-openmpi.sh"
      assert_file_exists "${target_dir}/.gpu-devops/third_party/install-hdf5.sh"
      assert_file_exists "${target_dir}/.gpu-devops/third_party/install-h5engine.sh"
      assert_file_exists "${target_dir}/.gpu-devops/third_party/install-muparserx.sh"
      ...
      assert_file_exists "${target_dir}/.gpu-devops/third_party/cache/cmake-3.26.0-linux-x86_64.tar.gz"
