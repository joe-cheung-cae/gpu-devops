...
assert_contains "${default_log}" "--build-arg CUDA_VERSION=12.9.1"
assert_contains "${default_log}" "-t ${DEFAULT_IMAGE_FAMILY}:ubuntu2404-12.9.1"
...
assert_contains "${ubuntu_log}" "--build-arg CUDA_VERSION=12.9.1"
assert_contains "${ubuntu_log}" "-t ${DEFAULT_IMAGE_FAMILY}:ubuntu2204-12.9.1"
...
assert_contains "${all_log}" "--build-arg CUDA_VERSION=12.4.0"
assert_contains "${all_log}" "-t ${DEFAULT_IMAGE_FAMILY}:centos7-12.4.0"
assert_contains "${all_log}" "-f ${ROOT_DIR}/docker/cuda-builder/centos7.Dockerfile"
assert_contains "${all_log}" "-t ${DEFAULT_IMAGE_FAMILY}:rocky8-12.9.1"
assert_contains "${all_log}" "-f ${ROOT_DIR}/docker/cuda-builder/rocky8.Dockerfile"
assert_contains "${all_log}" "-t ${DEFAULT_IMAGE_FAMILY}:rocky9-12.9.1"
assert_contains "${all_log}" "-f ${ROOT_DIR}/docker/cuda-builder/rocky9.Dockerfile"
assert_contains "${all_log}" "-t ${DEFAULT_IMAGE_FAMILY}:ubuntu2204-12.9.1"
assert_contains "${all_log}" "-f ${ROOT_DIR}/docker/cuda-builder/ubuntu2204.Dockerfile"
assert_contains "${all_log}" "-t ${DEFAULT_IMAGE_FAMILY}:ubuntu2404-12.9.1"
...
assert_contains "${ROOT_DIR}/docker/cuda-builder/centos7.Dockerfile" 'https://vault.centos.org/7.9.2009'
...
assert_contains "${ROOT_DIR}/docker/cuda-builder/centos7.Dockerfile" 'autoconf'
assert_contains "${ROOT_DIR}/docker/cuda-builder/centos7.Dockerfile" 'automake'
assert_contains "${ROOT_DIR}/docker/cuda-builder/centos7.Dockerfile" 'bison'
assert_contains "${ROOT_DIR}/docker/cuda-builder/centos7.Dockerfile" 'flex'
assert_contains "${ROOT_DIR}/docker/cuda-builder/centos7.Dockerfile" 'gcc-gfortran'
assert_contains "${ROOT_DIR}/docker/cuda-builder/centos7.Dockerfile" 'libtool'
assert_contains "${ROOT_DIR}/docker/cuda-builder/centos7.Dockerfile" 'm4'
assert_contains "${ROOT_DIR}/docker/cuda-builder/centos7.Dockerfile" 'patch'
assert_contains "${ROOT_DIR}/docker/cuda-builder/centos7.Dockerfile" 'pkgconfig'
assert_contains "${ROOT_DIR}/docker/cuda-builder/centos7.Dockerfile" 'xz'
...
assert_contains "${ROOT_DIR}/docker/cuda-builder/rocky8.Dockerfile" 'autoconf'
assert_contains "${ROOT_DIR}/docker/cuda-builder/rocky8.Dockerfile" 'automake'
assert_contains "${ROOT_DIR}/docker/cuda-builder/rocky8.Dockerfile" 'bison'
assert_contains "${ROOT_DIR}/docker/cuda-builder/rocky8.Dockerfile" 'flex'
assert_contains "${ROOT_DIR}/docker/cuda-builder/rocky8.Dockerfile" 'gcc-gfortran'
assert_contains "${ROOT_DIR}/docker/cuda-builder/rocky8.Dockerfile" 'libtool'
assert_contains "${ROOT_DIR}/docker/cuda-builder/rocky8.Dockerfile" 'm4'
assert_contains "${ROOT_DIR}/docker/cuda-builder/rocky8.Dockerfile" 'patch'
assert_contains "${ROOT_DIR}/docker/cuda-builder/rocky8.Dockerfile" 'pkgconf-pkg-config'
assert_contains "${ROOT_DIR}/docker/cuda-builder/rocky8.Dockerfile" 'xz'
assert_contains "${ROOT_DIR}/docker/cuda-builder/rocky9.Dockerfile" 'ENV PATH="/usr/local/bin:${PATH}"'
assert_not_contains "${ROOT_DIR}/docker/cuda-builder/rocky9.Dockerfile" 'gcc-toolset-11-binutils'
assert_not_contains "${ROOT_DIR}/docker/cuda-builder/rocky9.Dockerfile" 'gcc-toolset-11-gcc'
assert_not_contains "${ROOT_DIR}/docker/cuda-builder/rocky9.Dockerfile" 'gcc-toolset-11-gcc-c++'
assert_contains "${ROOT_DIR}/docker/cuda-builder/rocky9.Dockerfile" 'curl-minimal'
assert_not_contains "${ROOT_DIR}/docker/cuda-builder/rocky9.Dockerfile" '      curl \'
assert_contains "${ROOT_DIR}/docker/cuda-builder/rocky9.Dockerfile" 'autoconf'
assert_contains "${ROOT_DIR}/docker/cuda-builder/rocky9.Dockerfile" 'automake'
assert_contains "${ROOT_DIR}/docker/cuda-builder/rocky9.Dockerfile" 'bison'
assert_contains "${ROOT_DIR}/docker/cuda-builder/rocky9.Dockerfile" 'flex'
assert_contains "${ROOT_DIR}/docker/cuda-builder/rocky9.Dockerfile" 'gcc-gfortran'
assert_contains "${ROOT_DIR}/docker/cuda-builder/rocky9.Dockerfile" 'libtool'
assert_contains "${ROOT_DIR}/docker/cuda-builder/rocky9.Dockerfile" 'm4'
assert_contains "${ROOT_DIR}/docker/cuda-builder/rocky9.Dockerfile" 'patch'
assert_contains "${ROOT_DIR}/docker/cuda-builder/rocky9.Dockerfile" 'pkgconf-pkg-config'
assert_contains "${ROOT_DIR}/docker/cuda-builder/rocky9.Dockerfile" 'xz'
assert_contains "${ROOT_DIR}/docker/cuda-builder/ubuntu2204.Dockerfile" 'ENV PATH="/usr/local/bin:${PATH}"'
assert_contains "${ROOT_DIR}/docker/cuda-builder/ubuntu2204.Dockerfile" 'autoconf'
assert_contains "${ROOT_DIR}/docker/cuda-builder/ubuntu2204.Dockerfile" 'automake'
assert_contains "${ROOT_DIR}/docker/cuda-builder/ubuntu2204.Dockerfile" 'bison'
assert_contains "${ROOT_DIR}/docker/cuda-builder/ubuntu2204.Dockerfile" 'flex'
assert_contains "${ROOT_DIR}/docker/cuda-builder/ubuntu2204.Dockerfile" 'gfortran'
assert_contains "${ROOT_DIR}/docker/cuda-builder/ubuntu2204.Dockerfile" 'libtool'
assert_contains "${ROOT_DIR}/docker/cuda-builder/ubuntu2204.Dockerfile" 'm4'
assert_contains "${ROOT_DIR}/docker/cuda-builder/ubuntu2204.Dockerfile" 'patch'
assert_contains "${ROOT_DIR}/docker/cuda-builder/ubuntu2204.Dockerfile" 'pkg-config'
assert_contains "${ROOT_DIR}/docker/cuda-builder/ubuntu2204.Dockerfile" 'xz-utils'
assert_contains "${ROOT_DIR}/docker/cuda-builder/ubuntu2404.Dockerfile" 'ENV PATH="/usr/local/bin:${PATH}"'
assert_contains "${ROOT_DIR}/docker/cuda-builder/ubuntu2404.Dockerfile" 'autoconf'
assert_contains "${ROOT_DIR}/docker/cuda-builder/ubuntu2404.Dockerfile" 'automake'
assert_contains "${ROOT_DIR}/docker/cuda-builder/ubuntu2404.Dockerfile" 'bison'
assert_contains "${ROOT_DIR}/docker/cuda-builder/ubuntu2404.Dockerfile" 'flex'
assert_contains "${ROOT_DIR}/docker/cuda-builder/ubuntu2404.Dockerfile" 'gfortran'
assert_contains "${ROOT_DIR}/docker/cuda-builder/ubuntu2404.Dockerfile" 'libtool'
assert_contains "${ROOT_DIR}/docker/cuda-builder/ubuntu2404.Dockerfile" 'm4'
assert_contains "${ROOT_DIR}/docker/cuda-builder/ubuntu2404.Dockerfile" 'patch'
assert_contains "${ROOT_DIR}/docker/cuda-builder/ubuntu2404.Dockerfile" 'pkg-config'
assert_contains "${ROOT_DIR}/docker/cuda-builder/ubuntu2404.Dockerfile" 'xz-utils'
assert_contains "${ROOT_DIR}/docker/cuda-builder/ubuntu2404.Dockerfile" '--break-system-packages'
...
assert_contains "${ROOT_DIR}/docs/platform-contract.md" 'tf-particles/devops/cuda-builder:ubuntu2404-12.9.1'
assert_contains "${ROOT_DIR}/docs/platform-contract.md" 'BUILDER_CUDA_VERSION'
assert_contains "${ROOT_DIR}/docs/platform-contract.md" 'BUILDER_PLATFORM_CUDA_VERSIONS'
assert_contains "${ROOT_DIR}/docs/platform-contract.md" 'third_party/cache/cmake-3.26.0-linux-x86_64.tar.gz'
assert_contains "${ROOT_DIR}/docs/platform-contract.md" 'autoconf'
assert_contains "${ROOT_DIR}/README.md" 'source-build'
assert_contains "${ROOT_DIR}/.env.example" 'BUILDER_CUDA_VERSION=12.9.1'
assert_contains "${ROOT_DIR}/.env.example" 'BUILDER_IMAGE=tf-particles/devops/cuda-builder:ubuntu2404-12.9.1'
assert_contains "${ROOT_DIR}/.env.example" 'BUILDER_PLATFORM_CUDA_VERSIONS=centos7=12.4.0,rocky8=12.9.1,rocky9=12.9.1,ubuntu2204=12.9.1,ubuntu2404=12.9.1'
