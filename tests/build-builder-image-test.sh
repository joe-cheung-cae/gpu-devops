...
assert_contains "${ROOT_DIR}/docker/cuda-builder/install-eigen3.sh" 'Expected archive to exist: ${EIGEN3_ARCHIVE}'
...
assert_not_contains "${ROOT_DIR}/docker/cuda-builder/install-eigen3.sh" 'gitlab.com/libeigen/eigen/-/archive/${EIGEN3_VERSION}/${ARCHIVE}'
assert_not_contains "${ROOT_DIR}/docker/cuda-builder/install-eigen3.sh" 'curl -fsSL'
...
assert_contains "${ROOT_DIR}/docker/cuda-builder/install-chrono.sh" 'Expected archive to exist: ${CHRONO_ARCHIVE}'
...
assert_not_contains "${ROOT_DIR}/docker/cuda-builder/install-chrono.sh" 'CHRONO_GIT_URL'
assert_not_contains "${ROOT_DIR}/docker/cuda-builder/install-chrono.sh" 'CHRONO_GIT_REF'
assert_not_contains "${ROOT_DIR}/docker/cuda-builder/install-chrono.sh" 'git fetch --depth 1 origin "${CHRONO_GIT_REF}"'
assert_not_contains "${ROOT_DIR}/docker/cuda-builder/install-chrono.sh" 'git fetch origin "${CHRONO_GIT_REF}"'
assert_not_contains "${ROOT_DIR}/docker/cuda-builder/install-chrono.sh" 'git clone "${CHRONO_GIT_URL}" "${CHRONO_SOURCE_DIR}"'
assert_not_contains "${ROOT_DIR}/docker/cuda-builder/install-chrono.sh" 'git fetch --all --tags'
...
assert_contains "${ROOT_DIR}/scripts/prepare-builder-deps.sh" 'source "${ROOT_DIR}/scripts/common/env.sh"'
assert_contains "${ROOT_DIR}/scripts/prepare-builder-deps.sh" 'source "${ROOT_DIR}/scripts/common/images.sh"'
assert_contains "${ROOT_DIR}/scripts/prepare-builder-deps.sh" 'source "${ROOT_DIR}/scripts/common/archive.sh"'
assert_contains "${ROOT_DIR}/scripts/prepare-builder-deps.sh" 'source "${ROOT_DIR}/scripts/common/progress.sh"'
...
assert_contains "${ROOT_DIR}/scripts/prepare-builder-deps.sh" '/toolkit/third_party/install-third-party.sh'
assert_not_contains "${ROOT_DIR}/scripts/prepare-builder-deps.sh" '/toolkit/docker/cuda-builder/install-chrono.sh'
assert_not_contains "${ROOT_DIR}/scripts/prepare-builder-deps.sh" '/toolkit/docker/cuda-builder/install-eigen3.sh'
assert_not_contains "${ROOT_DIR}/scripts/prepare-builder-deps.sh" '/toolkit/docker/cuda-builder/install-openmpi.sh'
assert_not_contains "${ROOT_DIR}/scripts/prepare-builder-deps.sh" '/toolkit/docker/cuda-builder/install-hdf5.sh'
assert_not_contains "${ROOT_DIR}/scripts/prepare-builder-deps.sh" '/toolkit/docker/cuda-builder/install-h5engine.sh'
assert_not_contains "${ROOT_DIR}/scripts/prepare-builder-deps.sh" '/toolkit/docker/cuda-builder/install-muparserx.sh'
...
assert_contains "${ROOT_DIR}/third_party/install-third-party.sh" 'Usage: third_party/install-third-party.sh'
assert_contains "${ROOT_DIR}/third_party/install-third-party.sh" 'third_party_resolve_dep_order'
assert_contains "${ROOT_DIR}/third_party/install-third-party.sh" 'third_party_linux_install_command'
assert_contains "${ROOT_DIR}/third_party/install-third-party.sh" '--deps chrono,eigen3,openmpi,hdf5,h5engine,muparserx'
...
assert_not_contains "${ROOT_DIR}/scripts/compose.sh" 'CUDA_CXX_RUN_UID'
assert_not_contains "${ROOT_DIR}/scripts/compose.sh" 'CUDA_CXX_RUN_GID'
assert_not_contains "${ROOT_DIR}/scripts/compose.sh" 'id -u'
assert_not_contains "${ROOT_DIR}/scripts/compose.sh" 'id -g'
...
assert_contains "${ROOT_DIR}/docker-compose.yml" 'CUDA_CXX_PLATFORM_THIRD_PARTY_ROOT'
assert_contains "${ROOT_DIR}/docker-compose.yml" '/toolkit/third_party/install-third-party.sh'
...
assert_not_contains "${ROOT_DIR}/docker-compose.yml" 'install-chrono.sh'
assert_not_contains "${ROOT_DIR}/docker-compose.yml" '/toolkit/docker/cuda-builder/install-chrono.sh'
assert_not_contains "${ROOT_DIR}/docker-compose.yml" '/toolkit/docker/cuda-builder/install-eigen3.sh'
assert_not_contains "${ROOT_DIR}/docker-compose.yml" '/toolkit/docker/cuda-builder/install-openmpi.sh'
assert_not_contains "${ROOT_DIR}/docker-compose.yml" '/toolkit/docker/cuda-builder/install-hdf5.sh'
assert_not_contains "${ROOT_DIR}/docker-compose.yml" '/toolkit/docker/cuda-builder/install-h5engine.sh'
assert_not_contains "${ROOT_DIR}/docker-compose.yml" '/toolkit/docker/cuda-builder/install-muparserx.sh'
...
assert_contains "${ROOT_DIR}/.gitignore" '!third_party/cache/'
assert_contains "${ROOT_DIR}/.gitignore" 'third_party/cache/*'
assert_contains "${ROOT_DIR}/.gitignore" '!third_party/cache/*.tar.gz'
assert_contains "${ROOT_DIR}/.gitignore" '!third_party/cache/*.zip'
assert_contains "${ROOT_DIR}/.dockerignore" 'third_party/*'
assert_contains "${ROOT_DIR}/.dockerignore" '!third_party/cache/'
assert_contains "${ROOT_DIR}/.dockerignore" '!third_party/cache/*.tar.gz'
assert_contains "${ROOT_DIR}/.dockerignore" '!third_party/cache/*.zip'
