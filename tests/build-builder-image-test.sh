...
assert_contains "${ROOT_DIR}/docker/cuda-builder/centos7.Dockerfile" 'install-muparserx.sh'
assert_contains "${ROOT_DIR}/docker/cuda-builder/rocky8.Dockerfile" 'install-muparserx.sh'
assert_contains "${ROOT_DIR}/docker/cuda-builder/ubuntu2204.Dockerfile" 'install-muparserx.sh'
...
assert_contains "${ROOT_DIR}/docker/cuda-builder/install-muparserx.sh" 'MUPARSERX_SOURCE_DIR:=${HOME}/deps/muparserx'
assert_contains "${ROOT_DIR}/docker/cuda-builder/install-muparserx.sh" 'MUPARSERX_INSTALL_PREFIX:=${HOME}/deps/muparserx-install'
