...
EOF
  ...
  assert_contains "${test_dir}/stdout.log" "Starting [1/3] Preparing export for image registry.local/devops/cuda-builder:cuda11.7-cmake3.26-centos7"
  assert_contains "${test_dir}/stdout.log" "image size: 123456789 bytes"
  assert_contains "${test_dir}/stdout.log" "Finished [3/3] Preparing export for image registry.local/devops/cuda-builder:cuda11.7-cmake3.26-ubuntu2204"
